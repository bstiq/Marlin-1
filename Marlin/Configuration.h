...
#define STRING_CONFIG_H_AUTHOR "(lebastaq, Ender-3)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.68}
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -5, -1.61 }
